...
我们认为单一任务的分段AI，应该是商业落地的第一步，所以我们推论最可能热与机器人的未来是：一个通用智能，控制多个专用智能执行器。
...
- 执行层面：现有的手术机器人技术，可以完全操控完成叠衣的任务，所以执行器的产品化就是把手术机器人做大、做廉价。

所以我们认为这件事技术上看起来很不漂亮，但是目前成熟的解决方案，可以实现商业落地。
